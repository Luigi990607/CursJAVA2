...
public class DiceGame {
	...
	/*
	 * Facem un joc de zaruri unde avem urmatoarele:
	 * 1.Daca userul da in total 2, 6, 12 --> Pierde jocul
	 * 2. Daca userul da in total: 7, 11 --> Castiga jocul
	 * 3. Daca userul da in total: 3, 10 --> Repeta aruncarea
	 * 4. Daca userul da oricare alta varianta decat cele de mai sus il intrebam daca vrea sa 
	 * mai dea odata
	 * Raspunsul lui trebuie sa fie un boolean: TRUE sau FALSE.
	 * 
	 */
